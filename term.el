...
;; 2023-07-16 Improved color and sub-buffer handling imported from
;; Emacs-29 and made to work under Emacs-28.
...
otherwise use the current foreground color."
  (let ((color (if for-foreground term-ansi-current-color
                 term-ansi-current-bg-color)))
    (or (term-ansi-color--code-as-hex (1- color))
        (progn
...
;; copied from emacs-29 ansi-color
(defun term-ansi-color--code-as-hex (color)
