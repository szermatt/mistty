...
(ert-deftest mistty-test-set-mistty-skip-indent-and-end ()
  (ert-with-test-buffer ()
    ...
    (goto-char (point-min))
    (mistty--set-mistty-skip (point-min) 80)
...
(ert-deftest mistty-test-set-mistty-skip-ignore-skip-in-the-middle ()
  (ert-with-test-buffer ()
    (setq-local term-width 80)
...
(ert-deftest mistty-test-set-mistty-skip-ignore-nonws ()
  (ert-with-test-buffer ()
    (setq-local term-width 80)
...
(ert-deftest mistty-test-set-mistty-skip-right-prompt ()
  (ert-with-test-buffer ()
    ...
    (let* ((w 80)
      ...
      (goto-char (point-min))
      (mistty--set-mistty-skip (point-min) w))
