...
(defvar mistty-term-key-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "<delete>") "^[[3~")
    (define-key map (kbd "<down>") "^[OB")
    (define-key map (kbd "<down>") "^[[B")
    (define-key map (kbd "<end>") "^[OF")
    (define-key map (kbd "<f10>") "^[[21~")
    (define-key map (kbd "<f11>") "^[[23~")
    (define-key map (kbd "<f12>") "^[[24~")
    (define-key map (kbd "<f1>") "^[OP")
    (define-key map (kbd "<f1>") "^[[11~")
    (define-key map (kbd "<f2>") "^[OQ")
    (define-key map (kbd "<f2>") "^[[12~")
    (define-key map (kbd "<f3>") "^[OR")
    (define-key map (kbd "<f3>") "^[[13~")
    (define-key map (kbd "<f4>") "^[OS")
    (define-key map (kbd "<f4>") "^[[14~")
    (define-key map (kbd "<f5>") "^[[15~")
    (define-key map (kbd "<f6>") "^[[17~")
    (define-key map (kbd "<f7>") "^[[18~")
    (define-key map (kbd "<f8>") "^[[19~")
    (define-key map (kbd "<f9>") "^[[20~")
    (define-key map (kbd "<home>") "^[[1~")
    (define-key map (kbd "<insert>") "^[[2~")
    (define-key map (kbd "<kp-0>") "^[Op")
    (define-key map (kbd "<kp-1>") "^[Oq")
    (define-key map (kbd "<kp-2>") "^[Or")
    (define-key map (kbd "<kp-3>") "^[Os")
    (define-key map (kbd "<kp-4>") "^[Ot")
    (define-key map (kbd "<kp-5>") "^[Ou")
    (define-key map (kbd "<kp-6>") "^[Ov")
    (define-key map (kbd "<kp-7>") "^[Ow")
    (define-key map (kbd "<kp-8>") "^[Ox")
    (define-key map (kbd "<kp-9>") "^[Oy")
    (define-key map (kbd "<kp-add>") "^[Ok")
    (define-key map (kbd "<kp-divide>") "^[Oo")
    (define-key map (kbd "<kp-equal>") "^[OX")
    (define-key map (kbd "<kp-multiply>") "^[Oj")
    (define-key map (kbd "<kp-separator>") "^[Ol")
    (define-key map (kbd "<kp-subtract>") "^[Om")
    (define-key map (kbd "<left>") "^[OD")
    (define-key map (kbd "<left>") "^[[D")
    (define-key map (kbd "<menu>") "^[[29~")
    (define-key map (kbd "<next>") "^[[6~")
    (define-key map (kbd "<prior>") "^[[5~")
    (define-key map (kbd "<right>") "^[OC")
    (define-key map (kbd "<right>") "^[[C")
    (define-key map (kbd "<select>") "^[[4~")
    (define-key map (kbd "<up>") "^[OA")
    (define-key map (kbd "<up>") "^[[A")
    (define-key map (kbd "C-!") "^[[33;6u")
    (define-key map (kbd "C-#") "^[[35;6u")
    (define-key map (kbd "C-$") "^[[36;6u")
    (define-key map (kbd "C-%") "^[[37;6u")
    (define-key map (kbd "C-&") "^[[38;6u")
    (define-key map (kbd "C-'") "^[[39;5u")
    (define-key map (kbd "C-(") "^[[40;6u")
    (define-key map (kbd "C-)") "^[[41;6u")
    (define-key map (kbd "C-*") "^[[42;6u")
    (define-key map (kbd "C-+") "^[[43;6u")
    (define-key map (kbd "C-,") "^[[44;5u")
    (define-key map (kbd "C--") "^[[45;5u")
    (define-key map (kbd "C-.") "^[[46;5u")
    (define-key map (kbd "C-/") "^[[47;5u")
    (define-key map (kbd "C-0") "^[[48;5u")
    (define-key map (kbd "C-1") "^[[49;5u")
    (define-key map (kbd "C-9") "^[[57;5u")
    (define-key map (kbd "C-:") "^[[58;6u")
    (define-key map (kbd "C-;") "^[[59;5u")
    (define-key map (kbd "C-<") "^[[60;6u")
    (define-key map (kbd "C-<delete>") "^[[3;5~")
    (define-key map (kbd "C-<down>") "^[[1;5B")
    (define-key map (kbd "C-<end>") "^[[1;5F")
    (define-key map (kbd "C-<f10>") "^[[21;5~")
    (define-key map (kbd "C-<f11>") "^[[23;5~")
    (define-key map (kbd "C-<f12>") "^[[24;5~")
    (define-key map (kbd "C-<f1>") "^[O5P")
    (define-key map (kbd "C-<f2>") "^[O5Q")
    (define-key map (kbd "C-<f3>") "^[O5R")
    (define-key map (kbd "C-<f4>") "^[O5S")
    (define-key map (kbd "C-<f5>") "^[[15;5~")
    (define-key map (kbd "C-<f6>") "^[[17;5~")
    (define-key map (kbd "C-<f7>") "^[[18;5~")
    (define-key map (kbd "C-<f8>") "^[[19;5~")
    (define-key map (kbd "C-<f9>") "^[[20;5~")
    (define-key map (kbd "C-<home>") "^[[1;5H")
    (define-key map (kbd "C-<insert>") "^[[2;5~")
    (define-key map (kbd "C-<left>") "^[[1;5D")
    (define-key map (kbd "C-<next>") "^[[6;5~")
    (define-key map (kbd "C-<prior>") "^[[5;5~")
    (define-key map (kbd "C-<return>") "^[[13;5u")
    (define-key map (kbd "C-<right>") "^[[1;5C")
    (define-key map (kbd "C-<tab>") "^[[9;5u")
    (define-key map (kbd "C-<up>") "^[[1;5A")
    (define-key map (kbd "C-=") "^[[61;5u")
    (define-key map (kbd "C->") "^[[62;6u")
    (define-key map (kbd "C-?") "^[[63;6u")
    (define-key map (kbd "C-M-!") "^[[33;8u")
    (define-key map (kbd "C-M-#") "^[[35;8u")
    (define-key map (kbd "C-M-$") "^[[36;8u")
    (define-key map (kbd "C-M-%") "^[[37;8u")
    (define-key map (kbd "C-M-&") "^[[38;8u")
    (define-key map (kbd "C-M-'") "^[[39;7u")
    (define-key map (kbd "C-M-(") "^[[40;8u")
    (define-key map (kbd "C-M-)") "^[[41;8u")
    (define-key map (kbd "C-M-*") "^[[42;8u")
    (define-key map (kbd "C-M-+") "^[[43;8u")
    (define-key map (kbd "C-M-,") "^[[44;7u")
    (define-key map (kbd "C-M--") "^[[45;7u")
    (define-key map (kbd "C-M-.") "^[[46;7u")
    (define-key map (kbd "C-M-/") "^[[47;7u")
    (define-key map (kbd "C-M-0") "^[[48;7u")
    (define-key map (kbd "C-M-1") "^[[49;7u")
    (define-key map (kbd "C-M-2") "^[[50;7u")
    (define-key map (kbd "C-M-3") "^[[51;7u")
    (define-key map (kbd "C-M-4") "^[[52;7u")
    (define-key map (kbd "C-M-5") "^[[53;7u")
    (define-key map (kbd "C-M-6") "^[[54;7u")
    (define-key map (kbd "C-M-7") "^[[55;7u")
    (define-key map (kbd "C-M-8") "^[[56;7u")
    (define-key map (kbd "C-M-9") "^[[57;7u")
    (define-key map (kbd "C-M-:") "^[[58;8u")
    (define-key map (kbd "C-M-;") "^[[59;7u")
    (define-key map (kbd "C-M-<") "^[[60;8u")
    (define-key map (kbd "C-M-<delete>") "^[[3;7~")
    (define-key map (kbd "C-M-<down>") "^[[1;7B")
    (define-key map (kbd "C-M-<end>") "^[[1;7F")
    (define-key map (kbd "C-M-<home>") "^[[1;7H")
    (define-key map (kbd "C-M-<insert>") "^[[2;7~")
    (define-key map (kbd "C-M-<left>") "^[[1;7D")
    (define-key map (kbd "C-M-<next>") "^[[6;7~")
    (define-key map (kbd "C-M-<prior>") "^[[5;7~")
    (define-key map (kbd "C-M-<return>") "^[[13;7u")
    (define-key map (kbd "C-M-<right>") "^[[1;7C")
    (define-key map (kbd "C-M-<tab>") "^[[9;7u")
    (define-key map (kbd "C-M-<up>") "^[[1;7A")
    (define-key map (kbd "C-M-=") "^[[61;7u")
    (define-key map (kbd "C-M->") "^[[62;8u")
    (define-key map (kbd "C-M-?") "^[[63;8u")
    (define-key map (kbd "C-M-S-<delete>") "^[[3;8~")
    (define-key map (kbd "C-M-S-<down>") "^[[1;8B")
    (define-key map (kbd "C-M-S-<end>") "^[[1;8F")
    (define-key map (kbd "C-M-S-<home>") "^[[1;8H")
    (define-key map (kbd "C-M-S-<insert>") "^[[2;8~")
    (define-key map (kbd "C-M-S-<kp-0>") "^[O8p")
    (define-key map (kbd "C-M-S-<kp-1>") "^[O8q")
    (define-key map (kbd "C-M-S-<kp-2>") "^[O8r")
    (define-key map (kbd "C-M-S-<kp-3>") "^[O8s")
    (define-key map (kbd "C-M-S-<kp-4>") "^[O8t")
    (define-key map (kbd "C-M-S-<kp-5>") "^[O8u")
    (define-key map (kbd "C-M-S-<kp-6>") "^[O8v")
    (define-key map (kbd "C-M-S-<kp-7>") "^[O8w")
    (define-key map (kbd "C-M-S-<kp-8>") "^[O8x")
    (define-key map (kbd "C-M-S-<kp-9>") "^[O8y")
    (define-key map (kbd "C-M-S-<kp-add>") "^[O8k")
    (define-key map (kbd "C-M-S-<kp-divide>") "^[O8o")
    (define-key map (kbd "C-M-S-<kp-multiply>") "^[O8j")
    (define-key map (kbd "C-M-S-<kp-separator>") "^[O8l")
    (define-key map (kbd "C-M-S-<kp-subtract>") "^[O8m")
    (define-key map (kbd "C-M-S-<left>") "^[[1;8D")
    (define-key map (kbd "C-M-S-<next>") "^[[6;8~")
    (define-key map (kbd "C-M-S-<prior>") "^[[5;8~")
    (define-key map (kbd "C-M-S-<right>") "^[[1;8C")
    (define-key map (kbd "C-M-S-<up>") "^[[1;8A")
    (define-key map (kbd "C-M-SPC") "^[[32;7u")
    (define-key map (kbd "C-M-\"") "^[[34;8u")
    (define-key map (kbd "C-M-\\") "^[[92;7u")
    (define-key map (kbd "C-S-<delete>") "^[[3;6~")
    (define-key map (kbd "C-S-<down>") "^[[1;6B")
    (define-key map (kbd "C-S-<end>") "^[[1;6F")
    (define-key map (kbd "C-S-<f10>") "^[[21;6~")
    (define-key map (kbd "C-S-<f11>") "^[[23;6~")
    (define-key map (kbd "C-S-<f12>") "^[[24;6~")
    (define-key map (kbd "C-S-<f1>") "^[O6P")
    (define-key map (kbd "C-S-<f2>") "^[O6Q")
    (define-key map (kbd "C-S-<f3>") "^[O6R")
    (define-key map (kbd "C-S-<f4>") "^[O6S")
    (define-key map (kbd "C-S-<f5>") "^[[15;6~")
    (define-key map (kbd "C-S-<f6>") "^[[17;6~")
    (define-key map (kbd "C-S-<f7>") "^[[18;6~")
    (define-key map (kbd "C-S-<f8>") "^[[19;6~")
    (define-key map (kbd "C-S-<f9>") "^[[20;6~")
    (define-key map (kbd "C-S-<home>") "^[[1;6H")
    (define-key map (kbd "C-S-<insert>") "^[[2;6~")
    (define-key map (kbd "C-S-<kp-0>") "^[O6p")
    (define-key map (kbd "C-S-<kp-1>") "^[O6q")
    (define-key map (kbd "C-S-<kp-2>") "^[O6r")
    (define-key map (kbd "C-S-<kp-3>") "^[O6s")
    (define-key map (kbd "C-S-<kp-4>") "^[O6t")
    (define-key map (kbd "C-S-<kp-5>") "^[O6u")
    (define-key map (kbd "C-S-<kp-6>") "^[O6v")
    (define-key map (kbd "C-S-<kp-7>") "^[O6w")
    (define-key map (kbd "C-S-<kp-8>") "^[O6x")
    (define-key map (kbd "C-S-<kp-9>") "^[O6y")
    (define-key map (kbd "C-S-<kp-add>") "^[O6k")
    (define-key map (kbd "C-S-<kp-divide>") "^[O6o")
    (define-key map (kbd "C-S-<kp-multiply>") "^[O6j")
    (define-key map (kbd "C-S-<kp-separator>") "^[O6l")
    (define-key map (kbd "C-S-<kp-subtract>") "^[O6m")
    (define-key map (kbd "C-S-<left>") "^[[1;6D")
    (define-key map (kbd "C-S-<next>") "^[[6;6~")
    (define-key map (kbd "C-S-<prior>") "^[[5;6~")
    (define-key map (kbd "C-S-<return>") "^[[13;6u")
    (define-key map (kbd "C-S-<right>") "^[[1;6C")
    (define-key map (kbd "C-S-<tab>") "^[[9;6u")
    (define-key map (kbd "C-S-<up>") "^[[1;6A")
    (define-key map (kbd "C-\"") "^[[34;6u")
    (define-key map (kbd "C-\\") "^[[92;5u")
    (define-key map (kbd "M-<delete>") "^[[3;3~")
    (define-key map (kbd "M-<down>") "^[[1;3B")
    (define-key map (kbd "M-<end>") "^[[1;3F")
    (define-key map (kbd "M-<f10>") "^[[21;3~")
    (define-key map (kbd "M-<f11>") "^[[23;3~")
    (define-key map (kbd "M-<f12>") "^[[24;3~")
    (define-key map (kbd "M-<f1>") "^[O3P")
    (define-key map (kbd "M-<f2>") "^[O3Q")
    (define-key map (kbd "M-<f3>") "^[O3R")
    (define-key map (kbd "M-<f4>") "^[O3S")
    (define-key map (kbd "M-<f5>") "^[[15;3~")
    (define-key map (kbd "M-<f6>") "^[[17;3~")
    (define-key map (kbd "M-<f7>") "^[[18;3~")
    (define-key map (kbd "M-<f8>") "^[[19;3~")
    (define-key map (kbd "M-<f9>") "^[[20;3~")
    (define-key map (kbd "M-<home>") "^[[1;3H")
    (define-key map (kbd "M-<insert>") "^[[2;3~")
    (define-key map (kbd "M-<left>") "^[[1;3D")
    (define-key map (kbd "M-<next>") "^[[6;3~")
    (define-key map (kbd "M-<prior>") "^[[5;3~")
    (define-key map (kbd "M-<right>") "^[[1;3C")
    (define-key map (kbd "M-<up>") "^[[1;3A")
    (define-key map (kbd "M-S-<delete>") "^[[3;4~")
    (define-key map (kbd "M-S-<down>") "^[[1;4B")
    (define-key map (kbd "M-S-<end>") "^[[1;4F")
    (define-key map (kbd "M-S-<f10>") "^[[21;4~")
    (define-key map (kbd "M-S-<f11>") "^[[23;4~")
    (define-key map (kbd "M-S-<f12>") "^[[24;4~")
    (define-key map (kbd "M-S-<f1>") "^[O4P")
    (define-key map (kbd "M-S-<f2>") "^[O4Q")
    (define-key map (kbd "M-S-<f3>") "^[O4R")
    (define-key map (kbd "M-S-<f4>") "^[O4S")
    (define-key map (kbd "M-S-<f5>") "^[[15;4~")
    (define-key map (kbd "M-S-<f6>") "^[[17;4~")
    (define-key map (kbd "M-S-<f7>") "^[[18;4~")
    (define-key map (kbd "M-S-<f8>") "^[[19;4~")
    (define-key map (kbd "M-S-<f9>") "^[[20;4~")
    (define-key map (kbd "M-S-<home>") "^[[1;4H")
    (define-key map (kbd "M-S-<insert>") "^[[2;4~")
    (define-key map (kbd "M-S-<kp-0>") "^[O4p")
    (define-key map (kbd "M-S-<kp-1>") "^[O4q")
    (define-key map (kbd "M-S-<kp-2>") "^[O4r")
    (define-key map (kbd "M-S-<kp-3>") "^[O4s")
    (define-key map (kbd "M-S-<kp-4>") "^[O4t")
    (define-key map (kbd "M-S-<kp-5>") "^[O4u")
    (define-key map (kbd "M-S-<kp-6>") "^[O4v")
    (define-key map (kbd "M-S-<kp-7>") "^[O4w")
    (define-key map (kbd "M-S-<kp-8>") "^[O4x")
    (define-key map (kbd "M-S-<kp-9>") "^[O4y")
    (define-key map (kbd "M-S-<kp-add>") "^[O4k")
    (define-key map (kbd "M-S-<kp-divide>") "^[O4o")
    (define-key map (kbd "M-S-<kp-multiply>") "^[O4j")
    (define-key map (kbd "M-S-<kp-separator>") "^[O4l")
    (define-key map (kbd "M-S-<kp-subtract>") "^[O4m")
    (define-key map (kbd "M-S-<left>") "^[[1;4D")
    (define-key map (kbd "M-S-<next>") "^[[6;4~")
    (define-key map (kbd "M-S-<prior>") "^[[5;4~")
    (define-key map (kbd "M-S-<right>") "^[[1;4C")
    (define-key map (kbd "M-S-<up>") "^[[1;4A")
    (define-key map (kbd "S-<delete>") "^[[3;2~")
    (define-key map (kbd "S-<down>") "^[[1;2B")
    (define-key map (kbd "S-<end>") "^[[1;2F")
    (define-key map (kbd "S-<f10>") "^[[21;2~")
    (define-key map (kbd "S-<f11>") "^[[23;2~")
    (define-key map (kbd "S-<f12>") "^[[24;2~")
    (define-key map (kbd "S-<f1>") "^[[1;2P")
    (define-key map (kbd "S-<f2>") "^[[1;2Q")
    (define-key map (kbd "S-<f3>") "^[[1;2R")
    (define-key map (kbd "S-<f4>") "^[[1;2S")
    (define-key map (kbd "S-<f5>") "^[[15;2~")
    (define-key map (kbd "S-<f6>") "^[[17;2~")
    (define-key map (kbd "S-<f7>") "^[[18;2~")
    (define-key map (kbd "S-<f8>") "^[[19;2~")
    (define-key map (kbd "S-<f9>") "^[[20;2~")
    (define-key map (kbd "S-<home>") "^[[1;2H")
    (define-key map (kbd "S-<insert>") "^[[2;2~")
    (define-key map (kbd "S-<kp-0>") "^[O2p")
    (define-key map (kbd "S-<kp-1>") "^[O2q")
    (define-key map (kbd "S-<kp-2>") "^[O2r")
    (define-key map (kbd "S-<kp-3>") "^[O2s")
    (define-key map (kbd "S-<kp-4>") "^[O2t")
    (define-key map (kbd "S-<kp-5>") "^[O2u")
    (define-key map (kbd "S-<kp-6>") "^[O2v")
    (define-key map (kbd "S-<kp-7>") "^[O2w")
    (define-key map (kbd "S-<kp-8>") "^[O2x")
    (define-key map (kbd "S-<kp-9>") "^[O2y")
    (define-key map (kbd "S-<kp-add>") "^[O2k")
    (define-key map (kbd "S-<kp-divide>") "^[O2o")
    (define-key map (kbd "S-<kp-multiply>") "^[O2j")
    (define-key map (kbd "S-<kp-separator>") "^[O2l")
    (define-key map (kbd "S-<kp-subtract>") "^[O2m")
    (define-key map (kbd "S-<left>") "^[[1;2D")
    (define-key map (kbd "S-<next>") "^[[6;2~")
    (define-key map (kbd "S-<prior>") "^[[5;2~")
    (define-key map (kbd "S-<return>") "^[[13;2u")
    (define-key map (kbd "S-<right>") "^[[1;2C")
    (define-key map (kbd "S-<tab>") "^[[9;2u")
    (define-key map (kbd "S-<up>") "^[[1;2A")
